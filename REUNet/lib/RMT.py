...
class VisRetNet(nn.Module):
    def __init__(self, in_chans=2048, num_classes=1000,
                 ...
                 chunkwise_recurrents=[True, True, False, False], projection=2048,
                 layerscales=[False, False, True, True], layer_init_values=1e-6):
        super().__init__()
